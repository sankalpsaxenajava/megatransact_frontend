...
const MobileDataScreen: React.FC = () => {
  ...
  const requestContactPermission = async () => {
    ...
    if(Platform.OS == 'ios') {openContacts(); } 
    else
    {
      try {
        ...
        if (granted === PermissionsAndroid.RESULTS.GRANTED) {
          ...
          openContacts(); // Call your function here
        } else {
          ...
          <View>
            ...
            <TouchableOpacity
             onPress={() => requestContactPermission()}>
              <InputField
                iconName={require('../../assets/icons/contact.png')}
